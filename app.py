...
llm = ChatGoogleGenerativeAI(model="gemini-2.5-flash", temperature=0.7,api_key=GOOGLE_API_KEY)  # Ensure to set the API key in the environment or configuration
